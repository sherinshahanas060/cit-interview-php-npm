<template>
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">Add User Component</div>
              ...
              <div class="row">
                ...
                <div class="form-group col-sm-6">
                  ...
                  <Select2
                    ...
                    title="Status"
                    class="dropdaown-select2"
                    :class="{ 'is-invalid': form.errors.has('user_status') }"
                  ></Select2>
...
export default {
  ...
  methods: {
    ...
    createUser() {
      ...
      this.$mouse_disable();
      this.$Progress.start();
      let route = window.routes.userManageStore;
      this.form
        .post(route)
        .then(response => {
    ...
    updateUser() {
      ...
      let route = window.routes.userMangeUpdate;
      this.form
        .put(route + this.form.user_id)
        .then(() => {
          this.isLoading = false;
          toast.fire({
            type: "success",
     ...
     */
    loadUser(user_id) {
      let route = window.routes.showUserDetailsByUserId + user_id;
      axios
        .get(route)
        .then(response => {
          this.form.reset();
