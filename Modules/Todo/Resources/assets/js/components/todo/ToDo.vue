...
<template>
  <div>
    <!-- Own Task Tab -->
    <ul v-if="todoType == 1" class="list-unstyled" data-widget="todo-list">
      <li class="todo">
                  ...
                  <transition name="slide">
                    <div class="todo-filter" v-if="seenTodoDet">
                      <div class="col-12 font-min p-0 float-left">
                        ...
                        <span @click="removeTodo()">Delete</span>
                        </span>
                        <span
    ...
    <!-- Team Task Tab -->
    <ul v-if="todoType == 2" class="list-unstyled" data-widget="todo-list">
      <li class="todo">
        <a href="#" class="dropdown-item p-0">
          <!-- Message Start -->
          <div class="media">
            <div class="media-body col-12 p-0">
              <div
                v-b-tooltip.hover
                :title="checkOwngroup() ? '' : 'Access Denied!'"
                class="icheck-success todo-listings col-12 float-left"
              >
                <input
                  trueValue="1"
                  falseValue="0"
                  ...
                  <div class="col-12 p-0 float-left" @click="seenTodoDet = !seenTodoDet">
                    ...
                    <div class="col-12 float-left mt-2 p-0">
                      <div class="col-5 float-left p-0">
                        <span
                          @click="$emit('forwardTodo', todo)"
                          class="float-left text-sm theme-color forward-btn mr-2"
                        >
                          <i class="fa fa-forward"></i>
                          <span>Forward</span>
                        </span>
...
export default {
  ...
  methods: {
    removeTodo() {
      this.$store.commit("CACHE_REMOVED_TODO", this.todo);
    ...
    checkOwngroup() {
      return this.todo.assigned.some(obj => obj.assigned_to == user.id);
    }
  }
};
</script>